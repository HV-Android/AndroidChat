...
public class FirebaseHelper {
    ...
    public void changeUserConectionStatus(boolean online){
        if(getMyUserReference()!=null){
            ...
            notifyContactsOfConectionChange(online);
        }
    }

    public void notifyContactsOfConectionChange(boolean online) {
        notifyContactsOfConectionChange(online, false);
    }

    public void signOff(){
        notifyContactsOfConectionChange(false, true);
    }


    private void notifyContactsOfConectionChange(final boolean online, final boolean signoff) {
